...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:petr.matej@gmail.com?subject=${encodeURIComponent(form.subject)}&body=${encodeURIComponent(body)}`;
    setSent(true);
  };
    ...
    <div className="min-h-screen pb-16" style={{ background: "oklch(0.07 0.025 255)" }}>
      ...
      <div className="relative z-10 container max-w-2xl mx-auto py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {[
            { icon: <Mail className="w-5 h-5" />, title: "Email", value: "petr.matej@gmail.com" },
