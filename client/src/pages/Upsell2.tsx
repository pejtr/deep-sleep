...
import { ArrowRight, Lock, X, Star, Headphones, Check, Clock, Shield, Users, Volume2 } from "lucide-react";
...
export default function Upsell2() {
  ...
  const handleAccept = async () => {
    setLoading(true);
    track("upsell_accept", { page: "upsell2", value: { chronotype, price: 27 } });
    try {
    ...
    <div className="min-h-screen pb-10" style={{ background: "oklch(0.07 0.025 255)" }}>
      ...
      <div className="relative z-10 container max-w-lg mx-auto py-8 px-4">
        ...
        <div className="glass-card rounded-3xl p-6 md:p-8 mb-4" style={{ border: "1px solid oklch(0.65 0.15 280 / 0.4)" }}>
          <h2 className="font-bold text-lg mb-1" style={{ color: "oklch(0.75 0.15 280)" }}>
            🎧 ASMR Deep Sleep Audio Pack
          </h2>
          <p className="text-xs mb-4" style={{ color: "oklch(0.50 0.04 265)" }}>
            7 premium tracks · 18+ hours of content · Instant download
          </p>

          {/* Track list with value stack */}
          ...
          <div className="rounded-xl p-3 mb-5" style={{ background: "oklch(0.10 0.02 265)", border: "1px solid oklch(0.20 0.02 265)" }}>
            ...
            <p className="text-xs mt-1" style={{ color: "oklch(0.45 0.04 265)" }}>
              — Mike R., {chronotype} · verified buyer
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 mt-3">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs" style={{ color: "oklch(0.45 0.04 265)" }}>Instant download</span>
            </div>
            <div className="flex items-center gap-1">
              <Users className="w-3 h-3" style={{ color: "oklch(0.45 0.04 265)" }} />
              <span className="text-xs" style={{ color: "oklch(0.45 0.04 265)" }}>MP3 · All devices</span>
            </div>
          </div>
        </div>
