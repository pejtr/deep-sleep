...
const T: Record<Lang, Translations> = {
  ...
  de: {
    ...
    hero_cta: "Meinen Schlaf heute Nacht reparieren — $1",
    hero_guarantee: "30-Tage-Geld-zurück-Garantie · Sofortiger Zugang · Kein Abonnement",
    nav_cta: "Meinen Schlaf ändern — $1",
